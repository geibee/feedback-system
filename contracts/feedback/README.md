...
OpenAPI と各 schema は `@geibee/feedback-contracts/openapi.yaml`、`@geibee/feedback-contracts/schemas/*` から参照できます。
Redmine gatewayはlegacy Feedback Serviceへ混在させず、`@geibee/feedback-contracts/redmine-gateway.openapi.yaml`を正本にします。
